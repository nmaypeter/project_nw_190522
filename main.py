        ...
        for cm in cm_seq:
            ...
            for prod_setting in prod_seq:
                ...
                for wd in wd_seq:
                    ...
                    ModelPW('mngapsrpw', dataset_name, product_name, cascade_model, wallet_distribution_type).model_ngapsrpw()
                    ModelPW('mngapepw', dataset_name, product_name, cascade_model, wallet_distribution_type).model_ngapepw()
                    ModelPW('mngaprepw', dataset_name, product_name, cascade_model, wallet_distribution_type).model_ngaprepw()
                    ModelPW('mngapsrepw', dataset_name, product_name, cascade_model, wallet_distribution_type).model_ngapsrepw()
